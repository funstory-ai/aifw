...
export default defineConfig({
  ...
  server: {
    ...
    fs: {
      allow: [
        '..',
        '/Users/liuchangsheng/Work/funstory-ai/OneAIFW/libs',
        '/Users/liuchangsheng/Work/funstory-ai/OneAIFW/apps/webapp/node_modules',
        '/Users/liuchangsheng/Work/funstory-ai/OneAIFW/tests/transformer-js/public/models',
      ],
    },
    configureServer(server) {
      // Serve local models prepared under public/models
      const MODELS_ROOT = path.resolve(process.cwd(), 'public', 'models')
      server.middlewares.use((req, res, next) => {
        const raw = req.url || ''
        if (!raw.startsWith('/models/')) return next()
        let pathname = raw
        try { const u = new URL(raw, 'http://127.0.0.1'); pathname = u.pathname } catch {}
  ...
  resolve: {
    alias: {
      '@xenova/transformers': path.resolve(process.cwd(), 'node_modules/@xenova/transformers')
    }
  },
  optimizeDeps: {
